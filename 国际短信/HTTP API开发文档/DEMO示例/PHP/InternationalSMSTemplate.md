...
```
    ...
    //appid参数 appkey参数在     国际短信-创建/管理AppID中获取
    //生成模板如下
    //  您的验证码是@var(code)，请在@var(time)内输入。
    $appid = '6***3';                                                                   //appid参数
    $appkey = '5d****************************58';                                       //appkey参数
    $title = '国际短信模板标题';                                                              //国际短信模板标题
    $content = '您的验证码是@var(code)，请在@var(time)内输入。';                             //国际短信正文
    ...
    //模板ID   国际短信-创建/管理国际短信模板中获得
    //生成模板如下
    //  【国际短信模板签名】您的验证码是@var(code)，请在@var(time)内输入。
    $appid = '6***3';                                                                   //appid参数
    $appkey = '5d****************************58';                                       //appkey参数
    $title = '国际短信模板标题';                                                              //国际短信模板标题
    $signature = '国际短信模板签名';                                                          //国际短信模板签名
    $content = '您的验证码是@var(code)，请在@var(time)内输入。';                             //国际短信正文
    $template_id = 'F***U';                                                             //国际短信模板ID
