...
```
    ...
    $to_address_array = array('+81xxxxxxxx','+84xxxxxxxx');                         //收信人 手机号码列表
    $project = "F***U";                                                             //国际短信模板ID
    $multi = array();
    foreach ($to_address_array as $value) {
        $multi[] = array(
            'to'    => $value,
            'vars'  => array('code' => '1111','time' => '三分钟')                    //国际短信模板对应变量
        );
    }
    ...
    curl_setopt_array($ch , array(
        CURLOPT_URL             => 'https://api-v4.mysubmail.com/internationalsms/multixsend.json',
