...
public class ShortUrlDemo {
    ...
    private static final String URL = "https://service.mysubmail.com/shorturl.json";
    ...
    public static void main(String[] args) throws IllegalStateException, IOException {
        ...
        //get请求参数
//        String short_url = "https://suburl.cn/XvnXvT";
        String rows = "2";
        String offset = "0";
...
//        String url = "http://www.mysubmail.com";
        String group = "f682a4686de9d2ecfd6b2e34632bc925";
//        String item = "17602115149";
        String domain = "suburl.cn";
//        String access_password = "2233";
//        String access_limit = "4";
//        String expire = "3";
        String routes = "{\"desktop\": { \"windows\": {\"url\":\"https://www.mysubmail.com/windows\",\"model\":\"url\"}}}";

        //put请求参数
//        String short_url = "https://suburl.cn/K6/DGGWj5";
        ...
        switch (method) {
            case "post":
                ...
                requestData.put("group", group);
                requestData.put("domain", domain);
                requestData.put("access_password", access_password);
                requestData.put("access_limit", access_limit);
                requestData.put("expire", expire);
                requestData.put("routes", routes);
                requestData.put("url", url);
                requestData.put("item", item);
            ...
            case "get":
                buildSignature(appid, appkey, signtype, requestData);
                requestData.put("short_url", short_url);
