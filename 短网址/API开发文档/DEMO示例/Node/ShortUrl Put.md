...
​    
    ...
    request({
        ...
        form: {
            appid:appid,
            signature:appkey,
            url : "https://www.mysubmail.com/mail",
            short_url : "https://suburl.cn/4eHaXL",
        }
    ...
    request({
        ...
        requestParams['url'] = "https://www.mysubmail.com/mail";
        requestParams['short_url'] = "https://suburl.cn/TqvXzL";
