...
{
	public class ShortUrlInfoDemo
	{
		private const string API_ShortUrlInfo = "https://service.mysubmail.com/shorturl/info.json";
		...
		public void Info()
		{
			...
			string response = Httppost(API_ShortUrlInfo, d);
