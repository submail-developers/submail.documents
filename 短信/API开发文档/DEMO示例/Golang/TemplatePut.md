...
```
const (
	API    = "https://api.mysubmail.com/message/template"
	APPID  = "10***"
	APPKEY = "f8a5**********************778df"
)
```
...
```
	...
	postdata["template_id"] = "KnBsv3"
	postdata["sms_title"] = "短信标题"          //此标题无实际使用意义
	postdata["sms_signature"] = "【SUBMAIL】" //短信签名
	postdata["sms_content"] = "这是一条put 的 demo 短信，感谢您使用 SUBMAIL 短信服务"
...
```
	...
	postdata["appid"] = APPID
	postdata["signature"] = ""
	postdata["template_id"] = "q4eRg3"
	postdata["sms_title"] = "title"
	postdata["sms_signature"] = "【SUBMAIl】"
	postdata["sms_content"] = "这是一条 demo 短信，感谢您使用 SUBMAIL 短信服务"
	postdata["timestamp"] = ""
