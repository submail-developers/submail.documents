...
{
	public class smsTemplateDemo
	{
		private const string API_smsTemplate = "https://api-v4.mysubmail.com/sms/template.json";
		private const string API_Timestamp = "https://api-v4.mysubmail.com/service/timestamp.json";

		public void template()
		{
			string appid = "656xxx";
			string appkey = "e1a1d01828b8xxxxx8e3d84bb19730f1";
			...
			//string sms_signature = "【xxxx】";
			//string sms_content = "您的验证码是@var(code)";
		...
		public string GetTemplate(string appid, string appkey, string template_id, string sign_type)
		{
			...
			string target_url = API_smsTemplate + "?appid=" + appid + "&amp;template_id=" + template_id + "&amp;sign_type=" + sign_type;
		...
		public string PostTemplate(string appid, string appkey, string sms_title, string sms_signature, string sms_content, string sign_type)
		{
			...
			return HttpMethod(API_smsTemplate, d, "POST");
		}
		...
		public string PutTemplate(string appid, string appkey, string template_id, string sms_title, string sms_signature, string sms_content, string sign_type)
		{
			...
			return HttpMethod(API_smsTemplate, d, "PUT");
		}
		...
		public string DeleteTemplate(string appid, string appkey, string template_id, string sign_type)
		{
			...
			return HttpMethod(API_smsTemplate, d, "DELETE");
		}
