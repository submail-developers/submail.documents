...
{
	public class smsXSendDemo
	{
		private const string API_smsXSend = "https://api-v4.mysubmail.com/sms/xsend.json";
		private const string API_Timestamp = "https://api-v4.mysubmail.com/service/timestamp.json";
		public void XSend()
		{
			string appid = "596xx";
			string appkey = "bf928d0116xxxx9ad58e2d7f";
			string to = "176xxxx5149";

			string project = "CtdN24";                                   //模板id
			...
			d.Add("vars", vars);
			string response = Httppost(API_smsXSend, d);
