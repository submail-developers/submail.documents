...
namespace SUBMAILDEMO
{
	...
	{
		private const string API_MessageMultiXSend = "https://api.mysubmail.com/message/multixsend.json ";
		...
		public void MultiXSend()
		{
			...
			string multi = JsonConvert.SerializeObject(new List<MultiMessageItem>() {
				...
				new MultiMessageItem() { to="176xxxx5149", vars = vars2}});
			...
			d.Add("multi", multi);
			string response = Httppost(API_MessageMultiXSend, d);
