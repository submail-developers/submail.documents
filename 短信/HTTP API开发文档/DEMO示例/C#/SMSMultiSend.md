...
{
	public class smsMultiSendDemo
	{
		private const string API_smsMultiSend = "https://api-v4.mysubmail.com/sms/multisend.json ";
		...
		public void MultiSend()
		{
			...
			string multi = JsonConvert.SerializeObject(new List<MultismsItem>() {
				...
				new MultismsItem() { to="176xxx5149", vars = vars2}});
			...
			d.Add("multi", multi);
			string response = Httppost(API_smsMultiSend, d);
