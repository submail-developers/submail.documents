...
```
const (
	API    = "https://api.mysubmail.com/mms/template"
	APPID  = "10***"
	APPKEY = "f8a5**********************778df"
)
```
...
```
   postdata := make(map[string]string)
	...
	page1["text"] = "尊敬的@var(name),今天是@var(week)"
	page2["text"] = "这是彩信的第二页-put"
...
```
	...
	page1 := make(map[string]interface{})
	page2 := make(map[string]interface{})
	page1["text"] = "这是彩信的第一页-put2"
	page2["text"] = "这是彩信的第二页-put2"
	page1["image"] = map[string]string{
		"data": "",
		"type": "image/png",
	}
	...
	//PUT请求
	data_list := make([]string, 0, 32)
	var data_str string
	for key, val := range postdata {
		data_list = append(data_list, key+"="+val)
	}
	data_str = strings.Join(data_list, "&amp;")
	data := strings.NewReader(data_str)
	req, _ := http.NewRequest("PUT", API, data)
