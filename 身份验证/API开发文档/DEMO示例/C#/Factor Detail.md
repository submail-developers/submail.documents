...
{
	public class FactorDetailDemo
	{
		private const string API_FactorDetail = "https://tpa.mysubmail.com/factor/detail.json";
		...
		public void Request()
		{
			...
			string response = Httppost(API_FactorDetail, d);
