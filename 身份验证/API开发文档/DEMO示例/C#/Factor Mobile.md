...
{
	public class FactorMoboileDemo
	{
		private const string API_FactorMobile = "https://tpa.mysubmail.com/factor/mobile.json";
		...
		public void Request()
		{
			...
			string signStr = "appkey=" + appkey + "&amp;mobile=" + mobile + "&amp;name=" + HttpUtility.UrlEncode(name, Encoding.UTF8).ToUpper() + "×tamp=" + timestamp;
