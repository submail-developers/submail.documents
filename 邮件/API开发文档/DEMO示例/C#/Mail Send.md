...
namespace SUBMAILDEMO
{
	...
	{
		private const string API_MailSend = "https://api-v4.mysubmail.com/mail/send.json";
		private const string API_Timestamp = "https://api-v4.mysubmail.com/service/timestamp.json";
		public void Send()
		{
			string appid = "16xxx";
			string appkey = "5d5d513xxxxxc6f57eb7e4c7a5a6";
			...
			d.Add("atta", atta.toJsonString());
			d.Add("headers", headers);
			string response = Httppost(API_MailSend, d);
	...
	class Atta
	{
		...
		public void add(String name, String path)
		{
			...
			jobject.Add("data", FileToBase64(path));
			jarray.Add(jobject);
		}
